...
Here is an example for <strong>Zone 5</strong>, featuring a large flowering shrub and some short groundcover.
...
<h3 class='text-center'>Examples of modern, linear garden bed's we've found online:</h3>
